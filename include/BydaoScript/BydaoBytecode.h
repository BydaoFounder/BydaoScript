...
enum BydaoOpCode : quint8 {
    ...
    GetByIdx,       // arg1 = не используется (индекс на стеке)
    SetByIdx,       // Использует три значения на стеке: значение, индекс, объект
    ...
    PushDict,       // arg1 - количество пар ключ-значение
    GetByKey,       // arg1 > 0 - ключ задается значением переменной
                    // arg1 = 0 - ключ на стеке
                    // arg1 < 0 - ключ задан значением константы
    SetByKey,       // Использует три значения на стеке: значение, ключ, объект
    ...
    FuncVal,        // определение анонимной функции (значение на стеке): arg2 - индекс объекта функции
