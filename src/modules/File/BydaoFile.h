...
// Объект файла
class BYDAOFILE_EXPORT BydaoFileObject : public BydaoObject {
...
private:
    ...
    QString filePath() const { return QFileInfo(m_file).absolutePath(); }
    ...
    bool method_isOpen(const QVector<BydaoValue>& args, BydaoValue& result);
